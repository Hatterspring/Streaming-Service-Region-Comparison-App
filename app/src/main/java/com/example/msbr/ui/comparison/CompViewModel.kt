...
class CompViewModel() : ViewModel() {
    ...
    data class ServiceByRegion(
        ...
        lateinit var serStrat: SerializationStrategy<ServiceByRegion>
        fun toJson(sbr: ServiceByRegion): String {
            return Json.encodeToString(serStrat, sbr)
        }

        fun toSBR(json: String): ServiceByRegion {
            return Json.decodeFromString<ServiceByRegion>(json)
        }
    }
